...
replacements = {
	...
	'.blog-logo img {([\s]*)((height: 26px;){1})([\s]*)}':'', #remove useless blog-logo img css -- before  0.5.10
	'.blog-logo img {([\s]*)((height: 30px;){1})([\s]*)}':'', #remove useless blog-logo img css -- 0.5.10
	'.blog-logo img {([\s]*)((max-height: 80px;){1})([\s]*)}':'', #same as above
	'.blog-logo img {([\s]*)((padding: 4px 0;){1})([\s]*)}':'', #same as above -- before 0.5.10
	'.blog-logo img {([\s]*)((padding: 5px 0;){1})([\s]*)}':'', #same as above -- 0.5.10
